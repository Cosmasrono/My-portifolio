...
const items = [
  {
    title: "Online Milk Booking System",
    description: "You can book milk delivery online",
    // image:
    ...
    logo: "devicon:nextjs",
    github: "https://github.com/Cosmasrono/Milk-system-Online",
  },
  {
  ...
  {
    title: "West pokot ecommerce",
    description:
      "NGO site that help the locals in west pokot sell there products online",
    // image:
  ...
  {
    title: "Online paypal intergration",
    description:
      " paypal working online in transaction",
    // image:
  ...
  // },
  {
    title: "Resume screener with AI",
    description:
      " screening your cv using to predict if your elligle for interview using Machine Learning",
    // image:
